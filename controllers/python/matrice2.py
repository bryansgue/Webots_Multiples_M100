...
os.environ["WEBOTS_CONTROLLER_URL"] = "robot2"
...
def main(robot, image_pu_rgb, image_pu_d, odometry_pu):
    ...
    #position = Prop1_node.getPosition()
    #print('Ball position: %f %f %f\n' %(position[0], position[1], position[2]))
    
    # Robot get Node
    UAV_node = robot.getFromDef('matrice2')
    ...
    # Incremento de ángulo en cada iteración
    delta_angle = math.radians(10)  # Incremento de 1 grado en cada iteración
...
if __name__ == '__main__':
    try:
        ...
        # Vision Topic 
        image_topic_rbg = "/sim2/color/image_raw"
        image_topic_d = "/camera2/aligned_depth_to_color/image_raw"
        ...
        odometry_topic = "/M2/dji_sdk/odometry"
        ...
        odometry_webots = "/drone2/odometry"
